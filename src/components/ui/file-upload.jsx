    ...
    <div className="w-full" {...getRootProps()}>
      <motion.div
        ...
        <input
          ...
          className="hidden" />
        <div
          className="absolute inset-0 mask-[radial-gradient(ellipse_a t_center,white,transparent)]">
          <GridPattern />
        </div>
                ...
                <motion.div
                  ...
                  <div className="flex justify-between w-full items-center gap-4">
                    ...
                    <motion.p
                      ...
                      animate={{ opacity: 1 }}
                      layout
                      className="rounded-lg px-2 py-1 w-fit shrink-0 text-sm text-neutral-600 bg-neutral-800  shadow-input">
...
//   return (
//     <div
//       className="flex bg-backgrounf  shrink-0 flex-wrap justify-center items-center gap-x-px gap-y-px  scale-105">
...
//                 index % 2 === 0
//                   ? "bg-background/50 "
//                   : "bg-gray-50z  shadow-[0px_0px_1px_3px_rgba(255,255,255,1)_inset]"
//               }`} />
//           );
//         }))}
//     </div>
